...
const normalizeData = (data) => {
  return data.map(row => {
    ...
    const rawGenero = (normalized.genero || normalized.gender || '').toString().trim().toLowerCase();
    let generoNorm = '';
    if (rawGenero === 'm' || rawGenero === 'masculino' || rawGenero === 'homem' || rawGenero === 'male') {
      ...
      generoNorm = 'Feminino';
    } else if (normalized.genero === 'Masculino' || normalized.genero === 'Feminino') {
      generoNorm = normalized.genero;
    }
